...
\\
\>[B]{}\Varid{outExpAr}\;(\Conid{Bin}\;\Varid{op}\;\Varid{expe}\;\Varid{expd})\mathrel{=}i_2\;(i_2\;(i_1\;(\Varid{op},(\Varid{expe},\Varid{expd})))){}\<[E]%
\\
\>[B]{}\Varid{outExpAr}\;(\Conid{Un}\;\Varid{op}\;\Varid{exp})\mathrel{=}i_2\;(i_2\;(i_2\;(\Varid{op},\Varid{exp}))){}\<[E]%
\\
\>[B]{}\mbox{\onelinecomment }{}\<[E]%
\\
\>[B]{}\Varid{recExpAr}\;\Varid{a}\mathrel{=}\Varid{baseExpAr}\;\Varid{id}\;\Varid{id}\;\Varid{id}\;\Varid{a}\;\Varid{a}\;\Varid{id}\;\Varid{a}{}\<[E]%
\\
\>[B]{}\mbox{\onelinecomment }{}\<[E]%
\\
...
\\
\>[B]{}\Varid{clean}\;(\Conid{N}\;\Varid{x})\mathrel{=}(i_2\;(i_1\;\Varid{x})){}\<[E]%
\\
\>[B]{}\Varid{clean}\;(\Conid{Bin}\;\Conid{Sum}\;\Varid{expe}\;\Varid{expd})\mathrel{=}(i_2\;(i_2\;(i_1\;(\Conid{Sum},(\Varid{expe},\Varid{expd}))))){}\<[E]%
\\
\>[B]{}\Varid{clean}\;(\Conid{Bin}\;\Conid{Product}\;(\Conid{N}\;\mathrm{0})\;\Varid{expd})\mathrel{=}i_2\;(i_1\;\mathrm{0}){}\<[E]%
\\
\>[B]{}\Varid{clean}\;(\Conid{Bin}\;\Conid{Product}\;\Varid{expe}\;(\Conid{N}\;\mathrm{0}))\mathrel{=}i_2\;(i_1\;\mathrm{0}){}\<[E]%
\\
\>[B]{}\Varid{clean}\;(\Conid{Bin}\;\Conid{Product}\;\Varid{expe}\;\Varid{expd})\mathrel{=}(i_2\;(i_2\;(i_1\;(\Conid{Product},(\Varid{expe},\Varid{expd}))))){}\<[E]%
\\
\>[B]{}\Varid{clean}\;(\Conid{Un}\;\Conid{Negate}\;\Varid{exp})\mathrel{=}(i_2\;(i_2\;(i_2\;(\Conid{Negate},\Varid{exp})))){}\<[E]%
\\
\>[B]{}\Varid{clean}\;(\Conid{Un}\;\Conid{E}\;\Varid{exp})\mathrel{=}(i_2\;(i_2\;(i_2\;(\Conid{E},\Varid{exp})))){}\<[E]%
\\
\>[B]{}\mbox{\onelinecomment }{}\<[E]%
\\[\blanklineskip]%
...
\column{E}{@{}>{\hspre}l<{\hspost}@{}}%
\>[B]{}\Varid{ad\char95 gen}\mathbin{::}\Conid{Floating}\;{}\<[21]%
\>[21]{}\Varid{a}\Rightarrow {}\<[E]%
\\
\>[B]{}\hsindent{5}{}\<[5]%
\>[5]{}\Varid{a}\to ()+(\Varid{a}+((\Conid{BinOp},((\Conid{ExpAr}\;\Varid{a},\Varid{a}),(\Conid{ExpAr}\;\Varid{a},\Varid{a})))+(\Conid{UnOp},(\Conid{ExpAr}\;\Varid{a},\Varid{a}))))\to (\Conid{ExpAr}\;\Varid{a},\Varid{a}){}\<[E]%
\\
\>[B]{}\Varid{ad\char95 gen}\;\Varid{f}\;(i_1\;())\mathrel{=}(\Conid{X},\mathrm{1}){}\<[E]%
\\
\>[B]{}\Varid{ad\char95 gen}\;\Varid{f}\;(i_2\;(i_1\;\Varid{b}))\mathrel{=}(\Conid{N}\;\Varid{b},\mathrm{0}){}\<[E]%
\\
\>[B]{}\Varid{ad\char95 gen}\;\Varid{f}\;(i_2\;(i_2\;(i_1\;(\Conid{Sum},((\Varid{a},\Varid{b}),(\Varid{c},\Varid{d}))))))\mathrel{=}(\Conid{Bin}\;\Conid{Sum}\;(\Varid{a})\;(\Varid{c}),\Varid{b}\mathbin{+}\Varid{d}){}\<[E]%
\\
\>[B]{}\Varid{ad\char95 gen}\;\Varid{f}\;(i_2\;(i_2\;(i_1\;(\Conid{Product},((\Varid{a},\Varid{b}),(\Varid{c},\Varid{d}))))))\mathrel{=}(\Conid{Bin}\;\Conid{Product}\;(\Varid{a})\;(\Varid{c}),(\Varid{calcPoint}\;\Varid{f}\;\Varid{a}\mathbin{*}\Varid{d})\mathbin{+}(\Varid{b}\mathbin{*}\Varid{calcPoint}\;\Varid{f}\;\Varid{c})){}\<[E]%
\\
\>[B]{}\Varid{ad\char95 gen}\;\Varid{f}\;(i_2\;(i_2\;(i_2\;(\Conid{Negate},(\Varid{a},\Varid{b})))))\mathrel{=}(\Conid{Un}\;\Conid{Negate}\;\Varid{a},\mathbin{-}\Varid{b}){}\<[E]%
\\
\>[B]{}\Varid{ad\char95 gen}\;\Varid{f}\;(i_2\;(i_2\;(i_2\;(\Conid{E},(\Varid{a},\Varid{b})))))\mathrel{=}(\Conid{Un}\;\Conid{E}\;\Varid{a},\Varid{expd}\;(\Varid{calcPoint}\;\Varid{f}\;\Varid{a})\mathbin{*}\Varid{b}){}\<[E]%
\\[\blanklineskip]%
\>[B]{}\Varid{calcPoint}\mathbin{::}\Conid{Floating}\;\Varid{a}\Rightarrow \Varid{a}\to \Conid{ExpAr}\;\Varid{a}\to \Varid{a}{}\<[E]%
\\
\>[B]{}\Varid{calcPoint}\;\Varid{f}\;\Conid{X}\mathrel{=}\Varid{f}{}\<[E]%
\\
\>[B]{}\Varid{calcPoint}\;\Varid{f}\;(\Conid{N}\;\Varid{a})\mathrel{=}\Varid{a}{}\<[E]%
\\
\>[B]{}\Varid{calcPoint}\;\Varid{f}\;(\Conid{Bin}\;\Conid{Sum}\;\Varid{a}\;\Varid{b})\mathrel{=}\Varid{calcPoint}\;\Varid{f}\;\Varid{a}\mathbin{+}\Varid{calcPoint}\;\Varid{f}\;\Varid{b}{}\<[E]%
\\
\>[B]{}\Varid{calcPoint}\;\Varid{f}\;(\Conid{Bin}\;\Conid{Product}\;\Varid{a}\;\Varid{b})\mathrel{=}\Varid{calcPoint}\;\Varid{f}\;\Varid{a}\mathbin{*}\Varid{calcPoint}\;\Varid{f}\;\Varid{b}{}\<[E]%
\\
\>[B]{}\Varid{calcPoint}\;\Varid{f}\;(\Conid{Un}\;\Conid{Negate}\;\Varid{a})\mathrel{=}\mathbin{-}\Varid{calcPoint}\;\Varid{f}\;\Varid{a}{}\<[E]%
\\
\>[B]{}\Varid{calcPoint}\;\Varid{f}\;(\Conid{Un}\;\Conid{E}\;\Varid{a})\mathrel{=}\Varid{expd}\;(\Varid{calcPoint}\;\Varid{f}\;\Varid{a}){}\<[E]%
\ColumnHook
\end{hscode}\resethooks
...
\column{B}{@{}>{\hspre}l<{\hspost}@{}}%
\column{E}{@{}>{\hspre}l<{\hspost}@{}}%
\>[B]{}\Varid{divPar}\;(\Varid{a},\Varid{b})\mathrel{=}\Varid{a}\div \Varid{b}{}\<[E]%
\\
\>[B]{}\Varid{auxDoisN}\mathrel{=}(\conj{\Varid{mul}}{\succ \comp \p2}\comp \conj{\Varid{mul}}{\succ \comp \p2}){}\<[E]%
\\
\>[B]{}\Varid{loop}\mathrel{=}\conj{\Varid{auxDoisN}\comp \p1}{\conj{\Varid{mul}}{\succ \comp \p2}\comp \p2}{}\<[E]%
\\
\>[B]{}\Varid{inic}\mathrel{=}((\mathrm{1},\mathrm{1}),(\mathrm{1},\mathrm{1})){}\<[E]%
\\
\>[B]{}\Varid{prj}\mathrel{=}\Varid{divPar}\comp \conj{\p1\comp \p1}{\Varid{mul}\comp \conj{\p1}{\Varid{mul}}\comp \p2}{}\<[E]%
\ColumnHook
\end{hscode}\resethooks
por forma a que
\begin{hscode}\SaveRestoreHook
...
\column{15}{@{}>{\hspre}l<{\hspost}@{}}%
\column{E}{@{}>{\hspre}l<{\hspost}@{}}%
\>[B]{}\mbox{\onelinecomment  [P0-tP0 +tP1,....]}{}\<[E]%
\\
\>[B]{}\Varid{calcLine}\mathbin{::}\Conid{NPoint}\to (\Conid{NPoint}\to \Conid{OverTime}\;\Conid{NPoint}){}\<[E]%
\\
...
\>[8]{}(\Varid{x}\mathbin{:}\Varid{xs})\to \lambda \Varid{z}\to \Varid{concat}\mathbin{\$}(\Varid{sequenceA}\;[\mskip1.5mu \Varid{singl}\comp \Varid{linear1d}\;\Varid{d}\;\Varid{x},\Varid{f}\;\Varid{xs}\mskip1.5mu])\;\Varid{z}{}\<[E]%
\\[\blanklineskip]%
\>[B]{}\Varid{g1}\;[\mskip1.5mu \mskip1.5mu]\mathrel{=}\Varid{nil}{}\<[E]%
\\
\>[B]{}\Varid{g1}\;[\mskip1.5mu \Varid{p}\mskip1.5mu]\mathrel{=}\underline{\Varid{p}}{}\<[E]%
\\[\blanklineskip]%
\>[B]{}\Varid{g2}\;\Varid{l}\mathrel{=}\lambda \Varid{pt}\to (\Varid{calcLine}\;((\p1\;\Varid{l})\;\Varid{pt})\;((\p2\;\Varid{l})\;\Varid{pt}))\;\Varid{pt}{}\<[E]%
\\[\blanklineskip]%
\>[B]{}\Varid{deCasteljau}\mathbin{::}[\mskip1.5mu \Conid{NPoint}\mskip1.5mu]\to \Conid{OverTime}\;\Conid{NPoint}{}\<[E]%
\\
...
\\
\>[B]{}\hsindent{4}{}\<[4]%
\>[4]{}\Varid{coalg}\;[\mskip1.5mu \Varid{a}\mskip1.5mu]\mathrel{=}i_1\;[\mskip1.5mu \Varid{a}\mskip1.5mu]{}\<[E]%
\\
\>[B]{}\hsindent{4}{}\<[4]%
\>[4]{}\Varid{coalg}\;\Varid{l}\mathrel{=}i_2\;\conj{\Varid{init}}{\Varid{tail}}\;\Varid{l}{}\<[E]%
\\
\>[B]{}\hsindent{4}{}\<[4]%
\>[4]{}\Varid{alg}\mathrel{=}\alt{\Varid{g1}}{\Varid{g2}}{}\<[E]%
\\[\blanklineskip]%
...
\column{B}{@{}>{\hspre}l<{\hspost}@{}}%
\column{E}{@{}>{\hspre}l<{\hspost}@{}}%
\>[B]{}\mbox{\onelinecomment  avg = < avg , length>}{}\<[E]%
\\
\>[B]{}\Varid{avg\char95 aux}\mathrel{=}(\Varid{ratio}\times\Varid{id})\comp \Varid{cataList}\;\Varid{avg\char95 len\char95 g}{}\<[E]%
\\[\blanklineskip]%
\>[B]{}\Varid{avg\char95 len\char95 g}\mathrel{=}\alt{\conj{\conj{\underline{\mathrm{0}}}{\underline{\mathrm{0}}}}{\underline{\mathrm{0}}}}{\conj{\conj{\Varid{addg}\comp (\Varid{id}\times\p1)\comp (\Varid{id}\times\p1)}{\succ \comp \p2\comp \p1\comp \p2}}{\succ \comp \p2\comp \p2}}{}\<[E]%
\\[\blanklineskip]%
\>[B]{}\Varid{addg}\;(\Varid{a},\Varid{b})\mathrel{=}\Varid{a}\mathbin{+}\Varid{b}{}\<[E]%
\\[\blanklineskip]%
\>[B]{}\Varid{ratio}\;(\Varid{n},\Varid{d})\mathrel{=}\Varid{n}\mathbin{/}\Varid{d}{}\<[E]%
\\[\blanklineskip]%
\>[B]{}\Varid{func}\;\Varid{a}\mathrel{=}\mathrm{0}{}\<[E]%
\ColumnHook
\end{hscode}\resethooks
...
\column{E}{@{}>{\hspre}l<{\hspost}@{}}%
\>[B]{}\mbox{\onelinecomment  avgLTree funcional mas a função foi alterada }{}\<[E]%
\\
\>[B]{}\Varid{avgLTree}\mathrel{=}\Varid{ratio}\comp \p1\comp \llparenthesis\, \Varid{gene}\,\rrparenthesis\;\mathbf{where}{}\<[E]%
\\
\>[B]{}\hsindent{4}{}\<[4]%
\>[4]{}\Varid{gene}\mathrel{=}(\Varid{gavg}\times\Varid{glen})\comp {}\<[29]%
\>[29]{}\conj{\Varid{recLTree}\;\p1}{\Varid{recLTree}\;\p2}{}\<[E]%
\\[\blanklineskip]%
\>[B]{}\Varid{gavg}\mathrel{=}\conj{\alt{\Varid{prop}}{\Varid{soma}}\comp (\Varid{recLTree}\;\p1)}{\alt{\underline{\mathrm{1}}}{\Varid{addg}}\comp (\Varid{recLTree}\;\p2)}\;\mathbf{where}{}\<[E]%
\\
\>[B]{}\hsindent{5}{}\<[5]%
\>[5]{}\Varid{soma}\;(\Varid{a},\Varid{b})\mathrel{=}\Varid{a}\mathbin{+}\Varid{b}{}\<[E]%
\\
\>[B]{}\hsindent{5}{}\<[5]%
\>[5]{}\Varid{prop}\;\Varid{a}\mathrel{=}\Varid{a}{}\<[E]%
\\[\blanklineskip]%
\>[B]{}\mbox{\onelinecomment  Right (Left 1,Left 2)}{}\<[E]%
\\
\>[B]{}\Varid{gsum}\mathrel{=}\alt{\Varid{prop}}{\Varid{soma}}\;\mathbf{where}{}\<[E]%
\\
\>[B]{}\Varid{soma}\;(\Varid{a},\Varid{b})\mathrel{=}\Varid{a}\mathbin{+}\Varid{b}{}\<[E]%
\\
\>[B]{}\Varid{prop}\;\Varid{a}\mathrel{=}\Varid{a}{}\<[E]%
\\[\blanklineskip]%
\>[B]{}\Varid{glen}\mathrel{=}\alt{\Varid{one}}{\Varid{add}}{}\<[E]%
\ColumnHook
\end{hscode}\resethooks
